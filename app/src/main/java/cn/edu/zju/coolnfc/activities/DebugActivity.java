...
import cn.edu.zju.coolnfc.reader.Ntag_Get_Version;
...
//	}
	...
	public int obtainAuthStatus() {
		try {
			...
			Ntag_Get_Version.Prod prod = (new Ntag_Get_Version(answer)).Get_Product();
			if (prod != Ntag_Get_Version.Prod.NTAG_I2C_1k_Plus && prod != Ntag_Get_Version.Prod.NTAG_I2C_2k_Plus) {
				mfu.close();
