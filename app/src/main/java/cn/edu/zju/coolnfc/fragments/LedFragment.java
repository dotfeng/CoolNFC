...
public class LedFragment extends Fragment implements OnClickListener {
	...
	public static void setButton(byte Bit_field) {
		...
		switch (pressed) {
		case 0 : 
			nxpPressedButtons.setImageResource(R.mipmap.no_pressed);
			break;
		case 1 : 
			nxpPressedButtons.setImageResource(R.mipmap.left_pressed);
			break;
		case 2 : 
			nxpPressedButtons.setImageResource(R.mipmap.middle_pressed);
			break;
		case 3 : 
			nxpPressedButtons.setImageResource(R.mipmap.left_middle_pressed);
			break;
		case 4 : 
			nxpPressedButtons.setImageResource(R.mipmap.right_pressed);
			break;
		case 5 : 
			nxpPressedButtons.setImageResource(R.mipmap.right_left_pressed);
			break;
		case 6 : 
			nxpPressedButtons.setImageResource(R.mipmap.middle_right_pressed);
			break;
		case 7 : 
			nxpPressedButtons.setImageResource(R.mipmap.all_pressed);
			break;
		default:
			nxpPressedButtons.setImageResource(R.mipmap.no_pressed);
			break;
