		...
		if (nfca.getTimeout() < 50) {		
			...
			try {
				...
				if (prod == Ntag_Get_Version.Prod.NTAG_I2C_1k || prod == Ntag_Get_Version.Prod.NTAG_I2C_2k
						|| prod == Ntag_Get_Version.Prod.NTAG_I2C_1k_T || prod == Ntag_Get_Version.Prod.NTAG_I2C_2k_T
						|| prod == Ntag_Get_Version.Prod.NTAG_I2C_1k_V || prod == Ntag_Get_Version.Prod.NTAG_I2C_2k_V
						|| prod == Ntag_Get_Version.Prod.NTAG_I2C_1k_Plus || prod == Ntag_Get_Version.Prod.NTAG_I2C_2k_Plus) {
            ...
            try {
                  ...
                  if (answer[0] == (byte) 0x04 && answer[12] == (byte) 0xE1
                	  ...
                	  try {	 
                		  ...
                		  for(int i = 0; i < 4; i++) {
                			  if(answer[i] != 0x00) {
                				  prod = Ntag_Get_Version.Prod.NTAG_I2C_1k_Plus;
                				  return new MinimalNtag_I2C_Commands(tag, prod);
                			  }
                		  }
                		  prod = Ntag_Get_Version.Prod.NTAG_I2C_1k;
                		  return new MinimalNtag_I2C_Commands(tag, prod);
                	  } catch (Exception e2) {
                		  e2.printStackTrace();
                		  mfu.close();
                	  ...
                	  try {	 
                		  ...
                		  for(int i = 0; i < 4; i++) {
                			  if(answer[i] != 0x00) {
                				  prod = Ntag_Get_Version.Prod.NTAG_I2C_2k_Plus;
                				  return new MinimalNtag_I2C_Commands(tag, prod);
                			  }
                		  }
                		  prod = Ntag_Get_Version.Prod.NTAG_I2C_2k;
                		  return new MinimalNtag_I2C_Commands(tag, prod);
                	  } catch (Exception e2) {
                		  e2.printStackTrace();
                		  mfu.close();
